...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.progressBarMainWindow = QProgressBar(MainWindow)
        ...
        self.verticalLayout.addWidget(self.progressBarMainWindow)
        ...
        sizePolicy3.setHeightForWidth(self.labelCoverAlbum.sizePolicy().hasHeightForWidth())
        self.labelCoverAlbum.setSizePolicy(sizePolicy3)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 767, 295))
